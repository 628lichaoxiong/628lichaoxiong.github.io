...
public class Txt2PdfServiceImpl implements File2PdfService {
    ...
    private Logger logger = LoggerFactory.getLogger(Txt2PdfServiceImpl.class);

    /**
     * simsun 宋体
     * simkai 楷体
     */
    private Font font = FontRepository.openFont(Txt2PdfServiceImpl.class.getClassLoader().getResourceAsStream("fonts/simsun.ttf"), FontTypes.TTF);
