...
<body>
	...
	<div class="mainBody">
		<form name="myform" action="${sourcePath}transnwork/addtransnwork" method="post" id="myform">
		<div class="table_form">
			<table width="88%" cellspacing="0">
				<tr>
					<th width="18%">会议名称</th>
					<td><input type="text" class="input_txt required" name="meetingname" id="meet_name"></td>
				</tr>
				<tr>
					<th>行业标签</th>
					<td><input type="text" class="input_txt required" name="category" id="trade_label_txt"></td>
				</tr>
				<tr>
					<th></th>
				...
				<tr>
					...
					<td>
						<span class="select_new">
							<i>中文</i><input id="lang1" name="language1" value="中文" type="hidden" onchange="">
				...
				<tr>
					<th>会议时间</th>
					<td><input type="text" class="input_txt time_txt" name="meetingtime1" id="start_time" value="" readonly><a href="javascript:;" class="txt_dot">至</a><input type="text" class="input_txt time_txt" name="meetingtime2" id="end_time" value="" readonly><div id="timeTip"></div></td>
				</tr>
				<tr>
					<th>会议周期</th>
					<td><input type="text" class="input_txt" name="longtime1" id="cycle"  style="width:90px;" value=""> &nbsp;X 1天 &nbsp;+<input type="text" class="input_txt" name="longtime2" id="cycle_half"  style="width:100px; margin-left:35px;" value=""> &nbsp;X 0.5天</td>
				</tr>
				<tr>
					<th>会议城市</th>
					<td><span class="select_new" style="width:121px;">
							<i>北京</i><input id="meet_city" name="city" value="北京" type="hidden" onchange="">
							<span class="seleopt" style="display: none;">
				...
				<tr>
					<th>会议类型</th>
					<td><span class="select_new" style="width:121px;">
							<i>同传</i><input id="meet_type" name="type" value="同传" type="hidden" onchange="">
							<span class="seleopt" style="display: none;">
				...
				<tr>
					<th>会议联系人</th>
					<td><input type="text" class="input_txt required" name="meetinguser" id="meet_contactor" value="${username}" style="width:120px;"></td>
				</tr>
				<tr>
					<th>会议联系人手机号</th>
					<td><input type="text" class="input_txt required" name="userphonenumber" id="contact_phone" value="${phonenumber}" style="width:120px;"></td>
				</tr>
				<tr>
					<th>会议地址</th>
					<td><input type="text" class="input_txt optional" name="address" id="" value=""><div class="onShow">选填</div></td>
				</tr>
				<tr>
					<th>是否安排住宿</th>
					<td><span class="select_new" style="width:121px;">
				...
				<tr>
					<th>会议报名截止时间</th>
					<td><input type="text" class="input_txt time_txt" name="timeout" id="stop_time" value="" readonly><span class="tabtips">建议为会议创建时间顺延3天</span></td>
				</tr>
				<tr>
					<th>会议内容</th>
					<td><textarea class="input_area optional" name="workinfo" maxlength="150"></textarea><div class="onShow">选填</div></td>
				</tr><!-- 
				<tr>
					<th></th>
		...
		<div class="btn_wrap"><input type="submit" class="btn" value="提交" onclick="setDisable(this)"></div>
		</form>
	</div>
<script type="text/javascript">
<!--
	...
	function setMenu(){//或者自己设定导航逻辑
		var str = '<a href="javascript:;" onclick="url_jump(\'${sourcePath}transnwork/transnworklist\')">会议列表</a><b>&gt;</b><span>创建会议</span>';
	...
	function setDisable(dom){
		/* setTimeout(function(){
		var len = $('#myform').find('.onError').length;
		if(len==0)
