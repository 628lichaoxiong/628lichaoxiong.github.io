            ...
            <div class="add_card fl">
                <div class="order_information_left_c card_form">
                    <div class="list_div clearfix">
                            <p>角色名称</p>
                            <input type="text" name="roleName" maxlength="20" id="roleName" value="" placeholder="请输入角色名称"/>
                    </div>
                </div>
...
$(function(){
    ...
    //服务弹窗展示和选择处理
    function setMenu() {
        var str = '<a href="javascript:;" onclick="url_jump(\'${rc.contextPath}/ossRole/getRoleList\')">OSS角色管理列表</a><b>&gt;</b><span>新增角色</span>';
