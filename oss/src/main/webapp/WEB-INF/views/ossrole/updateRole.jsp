...
<body style="padding: 10px 30px 0 30px">
    ...
    <div class="new_back">
        ...
        <div class="new_card clearfix">
            <input id="roleId" type="hidden" name ="roleId" value="${ossRole.role.roleId}">
            <div class="add_card fl">
                <div class="order_information_left_c card_form">
                    <div class="list_div clearfix">
                            <p>角色名称</p>
                            <input type="text" name="roleName" maxlength="20" id="roleName" value="${ossRole.role.roleName}" placeholder="请输入角色名称"/>
                    </div>
                </div>
...
<!--错误提示弹窗-->
    <div id="showEorr"></div>
<script language="javascript" type="text/javascript" src="${rc.contextPath}/resources/js/ossRole.js"></script>
...
$(function(){
    ...
    //服务弹窗展示和选择处理
    function setMenu() {
        var str = '<a href="javascript:;" onclick="url_jump(\'${rc.contextPath}/ossRole/getRoleList\')">OSS角色管理列表</a><b>&gt;</b><span>修改角色</span>';
