                ...
                <div class="order_information_left_c card_form">
                    <div class="list_div clearfix">
                        <div class="order_information_left_list fl">
                            <p>手机号</p>
                            <input type="text" maxlength="11" name="phonenumber" id="phonenumber" value="" onkeyup="value=value.replace(/[^\d]/g,'')" placeholder="请输入手机号"/>
                        </div>
                    </div>
                    <div class="list_div clearfix">
                        <div class="order_information_left_list fl">
                            <p>登录名称</p>
                            <input type="text" maxlength="20" name="name" id="name" value=""  placeholder="请输入登录名称"/>
                        </div>
                    </div>
                     <div class="list_div clearfix">
                        <div class="order_information_left_list fl">
                            <p>登录密码</p>
                            <input type="text" maxlength="20" name="passwd" id="passwd" value=""  placeholder="请输入登录密码"/>
                        </div>
                    </div>
                    <div class="list_div clearfix">
                            <p>用户名称</p>
                            <input type="text" name="username" maxlength="20" id="username" value="" placeholder="请输入用户名称"/>
                    </div>
                    <div class="list_div clearfix">
                            <p>用户邮箱</p>
                            <input type="text" name="useremail" id="useremail"  value="" placeholder="请输入用户邮箱"/>
                    </div>
                </div>
