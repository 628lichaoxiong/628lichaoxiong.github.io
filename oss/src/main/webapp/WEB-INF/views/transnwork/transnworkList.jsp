						...
						<div class="row" style="padding: 20px;">
							...
							<div class="col-xs-10">
								<h4 style="margin-left:12px;">
									<a href="${sourcePath}transnwork/gettransnworkinfo?transnworkid=${Recourse.id}">
		...
		$(function() {
			...
			$(".deleteBtn").click(function(){
				if(window.confirm('你确定要删除吗？')){
					...
					window.location.href="${sourcePath}transnwork/deletetransnwork?id="+$(this).attr("data");
				}else{
			...
			.click(
					function() {
							...
							//alert("info");
							window.location.href = "${sourcePath}topic/topicDetail?topicid="
									+ $(this).attr("data");
